...
$runRoot = Join-Path $repoRoot "artifacts/perf/runs/dependency-injection/$runId"
...
Write-Output "PERF_DI_EVOLUTION_RUN_OK runId=$runId job=$Job order=v212,v220,v220,v212"
