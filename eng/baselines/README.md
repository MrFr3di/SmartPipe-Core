...
`baseline-report.md` is generated deterministically before `manifest.json` and summarizes the repository commit, package/snapshot hashes, and accepted workflow runs. Verification requires its bytes to match the manifest-derived report.
