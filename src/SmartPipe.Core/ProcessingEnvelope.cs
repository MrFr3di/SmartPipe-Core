...
/// <remarks>
/// <see cref="ProcessingEnvelope{T}"/> is the primary runtime model for SmartPipe.
/// Null payloads are valid only when <typeparamref name="T"/> permits null values; transforms should
/// not assume non-null payloads unless the generic type contract does so.
/// </remarks>
